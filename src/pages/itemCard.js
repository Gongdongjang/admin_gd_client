...
function ItemCard({  body , farmName ,storeName,style }) {
          ...
          <table  >
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <th style={{width:'200px',display: 'inline-block',marginRight:'5px'}}>{body.md_name}</th>
                  <th style={{width:'145px',display: 'inline-block'}}>{farm}</th>
                  <th style={{width:'145px',display: 'inline-block'}}>{store}</th>
                  <th style={{width:'150px',display: 'inline-block'}}>{body.pay_comp}</th>
                  ...
                  <th style={{width:'150px'}}><span id="resultGreen" >......</span>{body.stk_confirm}</th>
                </tr>
